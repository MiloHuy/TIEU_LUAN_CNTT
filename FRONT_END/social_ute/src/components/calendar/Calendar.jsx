      ...
      <div className="w-[300px] h-[430px] grid grid-cols-1 items-center">
        <div className="flex justify-between items-center w-[300px]">
          ...
          <div className="flex gap-8 items-center">
            ...
            <h1
              className=" cursor-pointer hover:scale-105 transition-all dark:text-white text-black font-quick_sans"
              onClick={() => {
            ...
            ({ date, currentMonth, today }, index) => {
              return (
                ...
                >
                  <h1
                    className={cn(
                      currentMonth ? "" : "dark:text-white text-black font-quick_sans",
                      today
                        ? "bg-red-600 text-white font-quick_sans"
                        : "",
                      selectDate
                        .toDate()
                        .toDateString() ===
                        date.toDate().toDateString()
                        ? "bg-black text-white font-quick_sans"
                        : "",
