import { BORDER_COLOR, RING_COLOR } from "constants/date-picker.const";
import { DATE_FORMAT } from "constants/date-time.const";
import DatepickerContext from "contexts/DatepickerContext";
import dayjs from "dayjs";
import { useCallback, useContext, useEffect, useRef } from "react";
import { dateIsValid, parseFormattedDate } from "utils/helpers.utils";
...
const Input = (e) => {
    ...
    const getClassName = useCallback(() => {
        ...
        const ring =
            RING_COLOR["second-focus"][primaryColor];

        const defaultInputClassName = `relative text-black transition-all bg-white dark:border-white duration-300 py-2.5 pl-4 pr-14 w-full border-2 border-black dark:bg-black dark:text-white rounded-md tracking-wide font-light text-sm placeholder-gray-400 focus:ring disabled:opacity-40 disabled:cursor-not-allowed ${border} ${ring}`;
