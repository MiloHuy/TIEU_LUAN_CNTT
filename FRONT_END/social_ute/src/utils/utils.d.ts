...
export type IconType<ComponentProps, AdditionalProps = NonNullable<unknown>> =
  | React.ReactNode
  | ((
      options: IconOptions<ComponentProps, AdditionalProps>,
    ) => React.ReactNode);

export type TemplateType<ComponentProps> =
  | React.ReactNode
