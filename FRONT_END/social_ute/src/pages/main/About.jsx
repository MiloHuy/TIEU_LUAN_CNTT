    ...
    <div className="relative w-full h-full items-center flex justify-center">
      <div className="flex flex-col items-center justify-around px-3 w-full h-full">
        ...
        <div className="flex gap-5">
          <div className="w-[30vw] h-max border border-black rounded-xl shadow-custom_shadow p-4">
            <div className="grid grid-cols-1 gap-2 justify-center">
              ...
              <div className="flex flex-col gap-2 w-full items-center">
                <p className="text-black  font-quick_sans font-bold text-md">
                  Huỳnh Hùng Phú
                </p>
                <p className="text-black  font-quick_sans font-bold text-md">
                  12/06/2002
                ...
                <p className="text-black  font-quick_sans font-bold text-md">
                  20110540@student.hcmute.edu.vn
                </p>
                <p className="text-black  font-quick_sans font-bold text-md">
          ...
          <div className="w-[30vw] h-max border  border-black rounded-xl shadow-custom_shadow p-4">
            <div className="grid grid-cols-1 gap-2 justify-center">
              ...
              <div className="flex flex-col gap-2 w-full items-center">
                ...
                <p className="text-black  font-quick_sans font-bold text-md">
                  20110494@student.hcmute.edu.vn
                </p>
                <p className="text-black  font-quick_sans font-bold text-md">
                  GVHD: Nguyễn Hữu Trung
                </p>
