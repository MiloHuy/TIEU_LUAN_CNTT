...
const ManagePosts = () => {
  ...
  const onIntersection = useCallback(
    (entries) => {
      ...
      if (firstEntries.isIntersecting && hasMore) {
        fetchAllPost(filter.page, filter.size);
      }
    },
  ...
  return (
    <div className="w-full h-screen overflow-y-scroll grid grid-cols-1 overflow-x-auto font-quick_sans">
      <div className="flex flex-col gap-3 h-full w-full p-4">
        <p className="text-black dark:text-white font-questrial font-bold text-2xl">
