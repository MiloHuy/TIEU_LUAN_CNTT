...
const FormLogin = (props) => {
  ...
  return (
    <form
      className={clsx(
        "h-[450px] min-w-[400px] flex flex-col items-center justify-center p-4 gap-4",
        props.className
      )}
    ...
    >
      ...
      <div className="w-full px-3 flex flex-col gap-8 justify-center items-center">
        <Input
          ...
          endContent={<Smartphone size={27} strokeWidth={1.25} />}
        />
        ...
        <Input
          ...
          onChange={formik.handleChange}
          endContent={<Eye size={27} strokeWidth={1.25} />}
        />
      </div>

      <div className="flex gap-2 justify-center w-3/4 px-3">
        <Button radius="sm" className="w-3/5 rounded-[40px] bg-[#1F1F24]">
          <Link className="text-lg font-questrial font-bold" to="/register">
            Đăng ký
          </Link>
        </Button>
